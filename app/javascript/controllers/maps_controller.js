...
export default class extends Controller {
  ...
  connect() {
    // Price label/value are server-rendered from the data-derived max and kept in sync by
    // applyFilters() (called at the end of connect), so no hard-coded default is needed here.
